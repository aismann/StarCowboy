...
void Radar::update(float dt)
{
    ...
    if (_player && _player.get()->isActive()) {
        ...
        if (playerEntity) {
            ...
            _drawNode->drawCircle({0, 0}, 100 * factor, 360, 64, false, 1, 1, {0.2, 0.2, 0.2, 0.5});
            _drawNode->drawCircle({0, 0}, 200 * factor, 360, 64, false, 1, 1, {0.2, 0.2, 0.2, 0.5});
            ...
            _drawNode->drawCircle({0, 0}, 500 * factor, 360, 64, false, 1, 1, {0.4, 0.4, 0.4, 0.5});
